...
//import 'package:hellobus/screens/ticket_page.dart'; // change the path if needed
...
class _PaymentScreenState extends State<PaymentScreen> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Divider(),
                const SizedBox(height: 10),
                summaryRow("Total Amount", "LKR 2,400.00",
                    isBold: true),
              ],
            ),
          ),
  ...
  //                Navigator.push(
  //   context,
  //   MaterialPageRoute(builder: (context) => const E_TicketPage()),
  // );
              },
              child: const Text(
                "Pay LKR 2,400.00",
            ...
            const Row(
              ...
              children: [
                ...
                SizedBox(width: 6),
                Text("Your payment is safe and secure.",
  ...
  Widget paymentOption(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(asset, size: 28, color: selected ? Colors.green : Colors.black),
